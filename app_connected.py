...
import pandas as pd
from forecast_utils import forecast_all_tickers
...
etf_name = df_ticker['ETF_Name'].iloc[0] if not df_ticker.empty else selected_ticker

# Display forecast table
st.subheader(f"📅 Forecast for {selected_ticker} — {etf_name}")
